...
| -------- | --------------------------------------------------------------------------- | ----- | ------ | ---------------- | --------------------------------------------------------------------- | ------ | ------------- |
| TASK-040 | Define contracts for registration, doc upload, vetting, re-evaluation       | BE    | 4 hrs  | —                | `contracts/provider-onboarding.yml`                                   | \[P]   | CRIT-020..024 |
| TASK-041 | Write contract tests for all endpoints                                      | QA/BE | S      | T040             | `tests/contracts/test_provider_onboarding.py`                         | \[S]   | CRIT-020..024 |
| TASK-042 | Implement `POST /providers/register` & questionnaire model                  | BE    | 2 hrs  | T041             | `apps/providers/views.py`                                             | \[S]   | CRIT-020      |
| TASK-043 | Implement `POST /providers/{id}/documents` with S3 upload + encryption      | BE    | 2 hrs  | T041             | `apps/providers/docs.py`                                              | \[S]   | CRIT-021      |
...
| TASK-046 | Directory visibility logic (Approved only)                                  | BE    | 4 hrs  | T045             | `apps/providers/search.py`                                            | \[S]   | CRIT-023      |
| TASK-047 | FE: provider onboarding forms (register, questionnaire, doc upload, status) | FE    | 8 hrs  | —                | `src/pages/register-provider.vue`, `src/components/VettingStatus.vue` | \[P]   | CRIT-020,021  |
| TASK-048 | FE: verification status indicator (pending, rejected, resubmit option)      | FE    | 1 hrs  | T047             | `src/components/VerificationBadge.vue`                                | \[S]   | CRIT-021      |
| TASK-049 | Auto-job: re-evaluation flagging (quarterly)                                | BE    | TBA    | T045             | `jobs/re-evaluation.py`                                               | \[S]   | CRIT-024      |
...
| TASK-106 | FE: thread list & detail view components                            | FE          | 1 hr   | —         | `src/pages/app/threads.vue`                                   | \[P]   | CRIT-050,051  |
| TASK-107 | FE: message input & bubble UI                                       | FE          | 1 hr   | T106      | `src/components/MessageInput.vue`, `MessageBubble.vue`        | \[S]   | CRIT-051      |
| TASK-108 | FE: attachment upload + preview + contract review                   | FE          | 4 hrs  | T106      | `src/components/AttachmentUploader.vue`, `ContractReview.vue` | \[S]   | CRIT-052,053  |
...
| TASK-147 | FE: Preferences page (toggle per category)                 | FE          | 1 hr   | T145      | `src/pages/preferences/notifications.vue`                             | \[S]   | CRIT-073      |
